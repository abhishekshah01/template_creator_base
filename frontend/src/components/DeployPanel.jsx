  ...
  return (
    <div className="border border-dashed border-[#30363d] rounded-2xl bg-[#0c1117] p-8 flex flex-col items-center justify-center text-center min-h-[400px]">
      ...
      <div className="inline-flex items-center gap-2 mb-5">
        <svg className="w-6 h-6 shrink-0" viewBox="0 0 49 48" fill="none">
          <circle opacity="0.1" cx="24.5" cy="24" r="24" fill="#F3CA5F" />
          <path fill="#F3CA5F" d="M24.5 4.799c10.604 0 19.2 8.596 19.2 19.2s-8.596 19.2-19.2 19.2-19.2-8.597-19.2-19.2 8.596-19.2 19.2-19.2Zm.98 11.015c-.633-1.568-1.166-2.093-1.925-.22-1.662 3.988-3.646 5.89-7.552 7.535-.392.181-1.099.496-1.103.87.005.373.707.687 1.103.869 3.902 1.64 5.89 3.547 7.552 7.536.769 1.905 1.303 1.307 1.925-.221 1.667-3.856 3.528-5.645 7.46-7.315.41-.197 1.09-.457 1.16-.85v-.044c-.07-.39-.745-.654-1.16-.85-3.932-1.672-5.793-3.46-7.46-7.317Z" />
        </svg>
