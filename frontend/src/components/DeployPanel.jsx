    ...
    <div className="border border-dashed border-[#30363d] rounded-2xl bg-[#0c1117] p-8 flex flex-col items-center justify-center text-center min-h-[400px]">
      ...
      <div className="inline-flex items-center gap-2 mb-5">
        <span className="inline-flex items-center justify-center w-6 h-6 rounded-full"
          style={{ background: 'radial-gradient(circle, rgba(249,197,19,0.22) 0%, rgba(249,197,19,0.08) 100%)' }}>
          <svg className="w-3.5 h-3.5" viewBox="0 0 16 16" fill="#f9c513">
            <path d="M8 0L9.6 6.4L16 8L9.6 9.6L8 16L6.4 9.6L0 8L6.4 6.4Z" />
          </svg>
        </span>
        <span className="text-[14px] font-semibold text-[#f9c513]">50 credits / deployment</span>
      </div>
