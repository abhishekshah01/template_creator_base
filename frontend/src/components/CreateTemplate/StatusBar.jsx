  ...
  return (
    <div className="mt-3 space-y-2">
      <div className="flex items-center gap-1 p-2 rounded-[6px] border text-[14px] leading-[1.5]"
        style={{ background: `linear-gradient(${s.bg}, ${s.bg}), #0d1117`, borderColor: s.border }}>
        {type === 'loading' && (
      ...
      {hint && (
        <div className="flex items-center gap-1 p-2 rounded-[6px] border text-[14px] leading-[1.5]"
          style={{ background: `linear-gradient(${HINT_STYLE.bg}, ${HINT_STYLE.bg}), #0d1117`, borderColor: HINT_STYLE.border }}>
