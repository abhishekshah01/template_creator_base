              ...
              <>
                {hasLive ? (
                  ...
                  <>
                    ...
                    <div className="flex items-center gap-1 p-2 rounded-[6px] mb-3"
                      style={{ backgroundColor: '#F3CA5F' }}>
                      <svg className="w-[22px] h-[22px] shrink-0 mx-1.5" viewBox="0 0 49 48" fill="none">
                        <g clipPath="url(#publish_coin_clip)">
                          <circle cx="24.5" cy="24" r="24" fill="#3d2f0a" />
                      ...
                      <span className="flex-1 text-[14px] font-medium leading-[1.5]" style={{ color: '#3d2f0a' }}>
                        <span className="font-semibold">50 credits</span> will be deducted for a successful deployment.
                      </span>
                    </div>
                  </>
                )}
